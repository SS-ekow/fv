...
const StatusPending =()=>{
  ...
  <div className='px-2 py-1 bg-gray-400 rounded-md text-gray-600 min-w-16 mx-auto'>
    Pending
  </div>
  )
}
...
const OrderStatusShipped =()=>{
  return(
    
  <div className='px-2 py-1 bg-gray-700 min-w-16 mx-auto rounded-md text-white'>
    Shipped
  </div>
  )
}
const OrderStatusReceived =()=>{
  return(
    
  <div className='px-2 py-1 bg-blue-600 min-w-16 mx-auto rounded-md text-white'>
    Received
  </div>
  )
}
